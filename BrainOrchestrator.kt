                ...
                when (actionType) {
                    "launch_app" -> {
                        ...
                        if (packageName.isNotEmpty()) {
                            ...
                            // Give app 1.5 seconds to launch before getting screen layout
                    ...
                    "type" -> {
                        ...
                        // Typing is done via accessibility pasting or simulated keyboard text input
                        // In clean Android framework, pasting text into focused field is best method:
                    ...
                    "speak" -> {
                        val text = action.optString("text")
                        speak(text)
                        // Speak actions usually finish the thread or request vocal review from the user
                        isRunning = false
                    }
                    "wait" -> {
